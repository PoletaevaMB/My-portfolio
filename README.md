...
<br> 
<p> Проект 4: Расчет продуктового АБ Теста в ритейлере </p>
<p>Что нужно было сделать:<p>
<ol>
  <li>Проанализировать и визуализировать результаты</li>
  <li>Провести сегментацию</li>
...
<p>Как решала:<p>
  <ol>
 <li>Импорт и анализ таблиц</li>
  <li>Объединение таблиц</li>
  <li>Автоматизация статистических вычислений (критерия Стьюдента, критерияй Манна Уитни )</li>
 <li> Чистка неверно заполненных точек.</li>
  <li>Расчет общих результатов АБ Теста</li>
  <li>Сегментация результатов АБ Теста</li>
<li> Отчет по АБ Тесту</li>
  <li>Создание калькулятора</li>
...
- Email: poletaeva.my-trip@yandex.ru
- Telegram: @ShaiennaV
- Mobile: 8 (985) 646-08-57
